...
class MainUserManager {
  ...
  async registerUser(email, password) {
    try {
      ...
      // ✅ STEP 4: Email duplicate check (OPTIONAL - different approach)
      // Agar aap duplicate check karna chahte hain, toh Firebase Auth use karein
      // createUserWithEmailAndPassword automatically fail ho jayega agar email already exists
